                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Chef_PostDish.this, "Item posted successfully", Toast.LENGTH_SHORT).show();

//                                    ChefHomeFragment homefrag = new ChefHomeFragment();
//                                    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
//                                    transaction.replace(R.id.fragment_container, homefrag);
//                                    transaction.commit();
                                }
                            });
                            firebaseDatabase.getInstance().getReference("Items").child(RandomUId)
                                    .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
