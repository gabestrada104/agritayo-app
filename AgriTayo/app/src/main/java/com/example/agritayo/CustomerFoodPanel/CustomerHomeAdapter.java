    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e(TAG, "Sizeeeeeeeeeeeeeeeeeeeeeeeee11" + updateDishModellist.toString());
                Log.e(TAG, "Sizeeeeeeeeeeeeeeeeeeeeeeeee11" + updateDishModellist.size());
                Log.i(TAG, "Sizeeeeeeeeeeeeeeeeeeeeeeeee11" + updateDishModellist.size());
