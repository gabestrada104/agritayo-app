...
import com.example.agritayo.CustomerFoodPanel_BottomNavigation;
import com.example.agritayo.R;
import com.example.agritayo.SendNotification.APIService;
import com.example.agritayo.SendNotification.Client;
import com.example.agritayo.SendNotification.Data;
import com.example.agritayo.SendNotification.MyResponse;
import com.example.agritayo.SendNotification.NotificationSender;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap1.put("Status", "Your order is waiting to be prepared by the seller...");
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        hashMap3.put("Status", "Your order is waiting to be prepared by the seller ...");
