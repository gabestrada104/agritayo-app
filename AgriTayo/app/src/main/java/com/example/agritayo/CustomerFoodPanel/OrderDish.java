    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("Items").child(RandomId);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        chefdata.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                String name = "<b>" + "Seller: " + "</b>" + chef.getFname() + " " + chef.getLname();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        data = FirebaseDatabase.getInstance().getReference("Items").child(RandomId);
