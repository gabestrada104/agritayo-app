...
import com.example.agritayo.ReusableCode.ReusableCodeForAll;
...
public class Registeration extends AppCompatActivity {
    ...
    String[] Pangasinan = {"Dagupan", "Calasiao"};
    String[] Tarlac = {"Camiling", "Conception"};


    String[] Dagupan = {"Gueset", "Boquig", "Binloc"};
    String[] Calasiao = {"Doyong", "Ambuetel", "Buenlag"};
    String[] Camiling = {"Anilong", "Bacbac", "Bacsay"};
    String[] Conception = {"Mabilog", "Magao", " Malupa", "Urdaneta", "Lingayen"};
        ...
        try {
            ...
            statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (statee.equals("Pangasinan")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Pangasinan) {
                            list.add(text);
                        }
                    ...
                    if (statee.equals("Tarlac")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Tarlac) {
                            list.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, list);
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Dagupan")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Dagupan) {
                            listt.add(text);
                        }
                    ...
                    if (cityy.equals("Calasiao")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Calasiao) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
                    ...
                    if (cityy.equals("Camiling")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Camiling) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
                    }
                    if (cityy.equals("Conception")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Conception) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
